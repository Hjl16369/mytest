...
安装依赖: pip install streamlit opencv-python pillow reportlab
"""
...
class PDFReportGenerator:
    ...
    def generate_report(self, result_data, original_image):
        ...
        try:
            ...
            # 标题
            story.append(Paragraph("正掌讯咽部健康筛查AI分析报告", title_style))
            ...
            story.append(Paragraph(
                "本报告由正掌讯AI系统自动生成，仅供健康筛查参考，不能替代专业医疗诊断。",
                disclaimer_style
            ))
            story.append(Paragraph(
                "如有不适症状，请及时就医咨询专业医生。",
...
def main():
    ...
    try:
        ...
        <div style='text-align: center; color: #888; padding: 20px;'>
            ...
            <p style='margin-top: 10px; font-size: 12px;'>© 2025 咽部健康筛查AI系统 | Powered by AI & 正讯软件</p>
        </div>
        """, unsafe_allow_html=True)
